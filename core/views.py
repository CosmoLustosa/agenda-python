...
def lista_eventos(request):
    ...
    #data_atual = datetime.now() - timedelta(hours=1) #timedelta atrasa o horario uma hora
    evento = Evento.objects.filter(usuario=usuario)#,
                                  # data_evento__gt=data_atual) # __gt trás as data iguais ou superiores à data atual
